...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    const bono_PersonalInfo: PersonalInfo = new PersonalInfo("Bono", "IJpelaar", new Date(1995, 4, 24), "Enschotsestraat", "111-24", "5014DD", "Tilburg", "The Netherlands");
    ...
    const reinoud_PersonalInfo: PersonalInfo = new PersonalInfo("Reinoud", "van Zoelen", new Date(1995, 5, 22), "Hertogensingel", "31", "5341AB", "Oss", "The Netherlands");

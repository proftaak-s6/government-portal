...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    ...
    const bono_Owner: Owner = new Owner("ijpelaar@gmail.com", bono_PersonalInfo, new Array<Car>(bono_Car));
    ...
    const reinoud_Owner: Owner = new Owner("vanzoelen@gmail.com", reinoud_PersonalInfo, new Array<Car>());
